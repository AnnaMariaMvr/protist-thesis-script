#   Thesis script, community analysis    #
...
ps_cleaned <- readRDS("data/Anna_Maria_cleaned_phyloseq.rds")
PO.mod <- readRDS("data/PO.mod.rds")
...
sample_data() Sample Data:       [ 671 samples by 41 sample variables ]
